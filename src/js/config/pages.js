...
export default {
    ...
    'heyue.index': {
        title: 'heyue_index',
        url: '/pages/heyue/index.js',
    },
    'heyue.classify': {
        title: 'heyue_classify',
        url: '/pages/heyue/classify.js',
    },
    'heyue.list': {
        title: 'heyue_list',
        url: '/pages/heyue/list.js',
    },
    'heyue.member': {
        title: 'heyue_member',
        url: '/pages/heyue/member.js',
    },
    'heyue.proCont': {
        title: 'heyue_proCont',
        url: '/pages/heyue/proCont.js',
    },
    'heyue.proList': {
        title: 'heyue_proList',
        url: '/pages/heyue/proList.js',
    },
    'heyue.web': {
        title: 'heyue_web',
        url: '/pages/heyue/web.js',
    },
