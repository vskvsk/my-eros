...
module.exports = {
    "exports": [
        ...
        "js/pages/heyue/index.vue",
        "js/pages/heyue/classify.vue",
        "js/pages/heyue/list.vue",
        "js/pages/heyue/member.vue",
        "js/pages/heyue/proCont.vue",
        "js/pages/heyue/web.vue",
        "js/pages/heyue/proList.vue",
    ],
    "alias": {
